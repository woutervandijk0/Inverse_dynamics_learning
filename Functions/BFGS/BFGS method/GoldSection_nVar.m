...
function ReturnValue = ...
   GoldSection_nVar(tol,x,s,lowbound,intvl,ntrials,varargin)
format compact;

% find upper bound
upval = UpperBound_nVar(x,s,lowbound,intvl,ntrials,varargin{:});
...
aL = lowbound;              xL = x + aL*s; faL = nlml(xL,varargin{:});	
a1 = (1-tau)*aL + tau*au;   x1 = x + a1*s; fa1 = nlml(x1,varargin{:});
a2 = tau*aL + (1 - tau)*au; x2 = x + a2*s; fa2 = nlml(x2,varargin{:});
