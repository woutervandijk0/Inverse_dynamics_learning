/* File    : solve_linSystem_sfun.c
 * Abstract:
 *
 * solve a linear system A*X = B using LAPACK/DPOTRS.
 *
 *
...
#define S_FUNCTION_NAME  solve_linSystem_sfun
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
	...
	ipiv = (int_T*) malloc(n * sizeof(int_T));		   /* allocate memory */
	...
	dgesv(&n, &m, A, &n, ipiv, X, &n, &info);
	
	if (info < 0) mexErrMsgTxt("Error: illegal input to solve_linSystem_sfun");
}
