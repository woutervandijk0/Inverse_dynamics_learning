...
batchSize  =  20;           % Size of batched received each timestep
...
N_query    =  20;           % Predict N number of timesteps in the future
...
ell     =   ones(NX*Q,P)*exp(1);     % Length scales (at t=0, 1)
